export const TOOL_SECTION_CONTENT: {title: string, body: string}[] = [
    {
        title: 'Power up and down your server with just a few clicks',
        body: 'Lodestone is the perfect tool for Minecraft server management on a local level. \
    ...
    {
        title: 'Manage player permissions and world settings',
        body: 'Lodestone gives you the power to manage your players and worlds with ease. With our easy to use interface, \
    ...
    {
        title: 'Generate detailed reports of server activity',
        body: 'Lodestone gives server admins the ability to generate detailed reports of server activity, \
    ...
    {
        title: 'Get real-time alerts of server events',
        body: 'Lodestone allows you to set up alerts for when certain events occur on your server, so you can stay up-to-date on what\'s happening even when you\'re away.'
    },
    {
        title: 'And much, much more!',
        body: 'The Lodestone team is committed to improving and adding new features to our client. \
